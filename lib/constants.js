...
export function todayStr() {
  // Sengaja pakai komponen tanggal lokal (bukan toISOString/UTC) supaya
  // tidak selisih satu hari di dini hari WIB (UTC+7) dibanding tanggal
  // kalender yang dilihat pengguna.
  const d = new Date();
